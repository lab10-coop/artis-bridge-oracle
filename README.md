...
| `RELAY_TXS` | Specifies which transactions this validator should relay to the Foreign network. By default it's those (randomly) assigned to it. | `none` / `assigned` / `all` |
